...
@Feature("Тестирование покупки тура кредитной картой")
public class CreditPageTest {
    ...
    @DisplayName("Оплата по кредитной карте со статусом APPROVED")
    @Test
    void shouldPaymentWithApprovedCard() {
        ...
        String actual = DBHelper.getStatusCredit();
        assertEquals("APPROVED", actual);
    }

    @DisplayName("Оплата по кредитной карте со статусом DECLINED")
    @Test
